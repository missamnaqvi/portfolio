...
export default function Hero() {
  return (
    <section className="container flex flex-col items-center justify-center min-h-screen bg-[#F0EDCC] text-[#02343F] text-center p-6">
      <motion.h1
      ...
      <motion.p
        className="text-xl text-[#02343F] max-w-2xl"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.3 }}
      >
        Full Stack Developer | Web & Infrastructure Enthusiast. I specialize in
