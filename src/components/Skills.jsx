      ...
      <div class="container flex flex-col md:flex-row items-center md:items-start gap-16 w-full">
        ...
        <div class="w-full md:w-1/2 relative p-6 sm:px-28 md:p-0">
          ...
          <span class="py-4 px-2 space-x-2 rounded-lg bg-secondary shadow-lg">
            <button class="rounded-lg px-4 py-2 text-black border-0 outline-0 transition-all duration-300">
              Skills
            </button>
            <button class="rounded-lg px-4 py-2 text-black border-0 outline-0 transition-all duration-300">
              Tools
          ...
          <div class="grid grid-cols-3 md:grid-cols-4 gap-4">
            ...
            <div class="text-center bg-[#02343F] text-white">
              <div class="p-4 bg-secondary rounded-lg shadow-lg flex flex-col justify-center items-center">
                ...
                <p class="text-xs mt-2">JavaScript</p>
              </div>
            </div>
            ...
            <div class="text-center bg-[#02343F] text-white">
              <div class="p-4 bg-secondary rounded-lg shadow-lg flex flex-col justify-center items-center">
                ...
                <p class="text-xs mt-2">TypeScript</p>
              </div>
            </div>
            ...
            <div class="text-center bg-[#02343F] text-white">
              <div class="p-4 bg-secondary rounded-lg shadow-lg flex flex-col justify-center items-center">
                ...
                <p class="text-xs mt-2">Nuxt.js</p>
              </div>
            </div>
            ...
            <div class="text-center bg-[#02343F] text-white">
              <div class="p-4 bg-secondary rounded-lg shadow-lg flex flex-col justify-center items-center">
                ...
                <p class="text-xs mt-2">Laravel</p>
              </div>
            </div>
            ...
            <div class="text-center bg-[#02343F] text-white">
              <div class="p-4 bg-secondary rounded-lg shadow-lg flex flex-col justify-center items-center">
                ...
                <p class="text-xs mt-2">TailwindCSS</p>
              </div>
            </div>
